...
public class ExampleConfiguration extends Configuration {
    ...
    @StringPropertyList(description = "String - fixed list", keys = {"Small", "Medium", "Large"}, values = {"sm", "md", "lg"})
    String string_List;

    @StringPropertyListEdit(description = "String - textfield, customizable list", keys = {"Red", "Green", "Blue"}, values = {"r", "g", "b"})
    String string_Textfield_List;

    @StringPropertyListEdit(description = "String - textfield with regex, customizable list", regularExpression = "https://[\\w\\.-]+\\.electricbolt.co.nz/.*", keys = {"Dev", "Test", "Prod"}, values = {"https://dev.electricbolt.co.nz/list", "https://test.electricbolt.co.nz/list", "https://m.electricbolt.co.nz/list"})
    ...
    static {
        _encrypted_string_Textfield_ListValues.put("Red", BuildConfig.ENCRYPTED ? "" : "r");
        _encrypted_string_Textfield_ListValues.put("Green", BuildConfig.ENCRYPTED ? "PkQfHwaWmK94u9eB9mCfWmOk/vOIOacKivt1lptgJbUzUl2e8pmRnSVLkCeYxoSjPgKEx94t6e/BRhtgMbZyXoo2usUH5jdxaA8Hko" + "UtR4VuMHuZ4Gla+kyuNg1Ki6LC+xAD++dESITzX4EqCCCfVV/qv5u5c9NJYrc7TwNN8bXtVJ6+8hEQeWXdk/05p0wCDj" + "x8hIl+wfmjbKOYwl35mQMW/4EM7SEYFqExxMsR/dcHJG4X0Mw03hEfdqL9nk0anMEyx8ez03WmR8TiZg4UqpbARr6i8I" + "UYx6pMr2ZJjQUzllvTxGpT84VetpN1tvp/Ys+ygtOODZuSp3MjpG0M/tiyGe8g7gNIdauWxN1afdgB" : "g");
        _encrypted_string_Textfield_ListValues.put("Blue", BuildConfig.ENCRYPTED ? "jaIxDwexYEFUlmoG8QsdKYbj/g2zZWL0q5gmeWGCuLOwXvUHdB0CU7i4v/55LEi3UuN7L9Yj4zjWX//WZB0HFn5+9NZ8IG9xoc+uE+" + "vDMbxAKaqjA5IfJM38eVl0DK/hp0le3qOG11sd+GXoSXSDiwKWGoi" + "hqYZ6GUzgDTx8f2OlhqG/SUlm/jADLUNJj" + "K8czZ8fY+Fx75cj7OTlOl+nikFoE5BkR3exOYkeCmAY2KgCYyJQn2w3yaBS0tGafUjAIHIHITodrjG+IbjZLhZyG2/jx" + "kMjLNDs0GCWH6vh+mQ9h6Iwzq3UIZnK9zUn2D4cZV5I2StjPpPdAkGrsdIv0L/bQJZjAnidQIWOC5iB7poB" : "b");
    }
    ...
    static {
        _encrypted_string_RegexTextfield_ListValues.put("Dev", BuildConfig.ENCRYPTED ? "jm9SM4MEYa4FRbTrK23n6QWpBl0MfLolPPUrnaUcMcCzmJbzBT0MumGIEFFthMFbx5ZZta8mCIKYwBR2Cu/2b52rFUr2N8xCuWiWUR" + "S0erO6sxdY3bJSzRJPo70aGYzMLydVrxUtHv1BjeLTYaG/25hF5JYWf8/TOA4lBRgMsttwbiO+0D6u1qGh4pewpTD5lI" + "8jK39sY3DfSco7+61chGakI7n44y/+toqxWl8rEa5+I9eL0vDASfe7V2KvBhQGV8FLZDkVo0a0fqcCeq5AXU1bl0bMXI" + "B2anN1PdihbPjOLZgpllIzuY+Hy8gFfpoCGQRAiiPSI2YDxT+pg2fKUBMQ9OqFAC5fi+7DqfRhy6SRXjfemq5cDglwMG" + "npRI4JAQ==" : "https://dev.appfigurate.io/list");
        _encrypted_string_RegexTextfield_ListValues.put("Test", BuildConfig.ENCRYPTED ? "4H4M2YQ2XH+bm7FYVm1sQuN+DaUQdvJecWLKYo3peUYwNJsw+bE/ANFbtfD6xDWCnDW8Bs62tqYDtyg6YhucnTjx82c+axxKG/eDpE" + "d3nPdiWubrw3UwuWa8xKIH8RFVQyRDpWrCbSDG/rREiRdUUs4Lwer7uJfOa92u9iN56T5rgH7/IXfo2N///FxmN/6Tr2" + "vVXNVc+m3snBE8B05+4WUKuDLkjGcm" + "HfzlnRiQVyDDyNKDNr1vDoZduu5Fb5CwPfCrxNIJY4r0XFyPIv+pjAG/Z" + "8Tl2dud6SjCzKirb1Nc0ZeQsCKyhSXDN3PC82qMbviAlkCOvkZ2mca4mRcW1VqeR63Ujp37lCAZKExPdqSlElI4Z0J7/" + "dHuEyMFNP1/xngi3iuOxO6L7Qy9i/RTnQE=" : "https" + "://test.appfigurate.io/list");
        _encrypted_string_RegexTextfield_ListValues.put("Prod", BuildConfig.ENCRYPTED ? "IE7X1bkOQGAqCTtLk011hG0Kmj5l0RkSviSO6IfItnIlSEL66ZH1cO4vmN8FtjkWhD+zvcDzHkcsVSsqPrkmYJl29I2otn2dXa9tNI" + "ZMW3it1kyoyxnZLwzIJhPGORTMxeLN9h+U36lydUA4fASALFFP+uC+bVHVdvIVUMoGBDdoVwZAXyss4C+rgLTafkok4H" + "cz/a6rXC5SsluX8/LTnomluqfi8bgrSS2xJKKpHsQQllQmsshublBJ57bKn3EeKmo6DxwBuwBVA2nAdyoi1bLUYN+XN1" + "sjzLaAuYyZeDJGs9qiuj78HCyN4ZrcVe3x00AbNAlSISrZJrw2oMt3exSGFGKAenClYqwoVygDPIPI3vNFCRFcp29N7T" + "4S78K5AQ==" : "https://m.appfigurate.io/list");
    }
    ...
    @IntPropertyList(description = "int - fixed list", keys = {"None", "Low", "Zero", "High", "Urgent"}, values = {-100, -50, 0, 50, 100})
    int integer_List;
    ...
    @DoublePropertySlider(description = "double - slider", minValue = 0.0d, maxValue = 1000.0d, sliderIcon = IconSlider.IconSliderBrightness)
    double double_Slider;

    @DoublePropertyEdit(description = "double - textfield", minValue = 10.0d, maxValue = 20.0d)
    double double_Textfield;

    @DoublePropertyEdit(description = "double - textfield with regex", minValue = 5.0d, maxValue = 250.0d, regularExpression = "^(?:[1-9]\\d*|0)?(?:\\.\\d+)?$")
    double double_RegexTextfield;

    @DoublePropertyList(description = "double - fixed list", keys = {"None", "Low", "Zero", "High", "Urgent"}, values = {-100.0d, -50.0d, 0.0d, 50.0d, 100.0d}, restart = true)
    double double_List;

    @DoublePropertyListEdit(description = "double - textfield, customizable list", minValue = 0.0d, maxValue = 100.0d, keys = {"Failed", "Passed", "Excellence"}, values = {0.0d, 80.0d, 90.0d})
    double double_Textfield_List;

    @DoublePropertyListEdit(description = "double - textfield with regex, customizable list", minValue = 0.0d, maxValue = 366.0d, regularExpression = "^(0?[0-9]?[0-9]|[1-2][0-9][0-9]|3[0-5][0-9]|36[0-5])?(?:\\.\\d+)?$", keys = {"0 days", "1 month", "1 Year"}, values = {0.0d, 30.0d, 365.0d})
